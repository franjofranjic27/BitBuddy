...
class MarketOrderRepositoryIT extends BaseIntegrationTest {
...
//        // Erster Wert
//        MarketOrderEntity e1 = MarketOrderEntity.builder()
//                .symbol("ETH/USDT")
//                .price(2000.0)
//                .amount(0.5)
//                .type("BUY")
...
//        MarketOrderEntity e2 = MarketOrderEntity.builder()
//                .symbol("ETH/USDT")
//                .price(2100.0)
//                .amount(0.3)
//                .type("SELL")
...
//        repository.save(e2);
//
//        MarketOrderEntity latest = repository.findFirstBySymbolOrderByIdDesc("ETH/USDT");
//
